...
x_0i = [(x[0] + x[1]) / 2 for x in x_range]
dx_i = []
for i in range(3):
    dx_i.append(x_range[i][1] - x_0i[i])
...
natur_plan_raw = [[15, -25, 45],
                  ...
                  [45, -25, 45],
                  [45, 10, 50],
                  [-l * dx_i[0] + x_0i[0], x_0i[1], x_0i[2]],
                  [l * dx_i[0] + x_0i[0], x_0i[1], x_0i[2]],
                  [x_0i[0], -l * dx_i[1] + x_0i[1], x_0i[2]],
                  [x_0i[0], l * dx_i[1] + x_0i[1], x_0i[2]],
                  [x_0i[0], x_0i[1], -l * dx_i[2] + x_0i[2]],
                  [x_0i[0], x_0i[1], l * dx_i[2] + x_0i[2]],
                  [x_0i[0], x_0i[1], x_0i[2]]]
...
def func(x1, x2, x3):
    coeffs = [8.7, 4.3, 1.2, 2.2, 0.4, 1.0, 6.4, 1.1, 0.1, 9.2, 1.2]
